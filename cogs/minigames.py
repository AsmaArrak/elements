...
TRIVIA_QUESTIONS = [
    ...
    # League of Legends
    {"q": "What is the name of the currency used to buy items in League of Legends?", "choices": ["Credits", "Gold", "Essence", "Coins"], "answer": 1},
    {"q": "Which champion is known as the 'Dark Child'?", "choices": ["Lux", "Annie", "Syndra", "Ahri"], "answer": 1},
    {"q": "What is the name of the main map in League of Legends?", "choices": ["The Crystal Scar", "Twisted Treeline", "Summoner's Rift", "Howling Abyss"], "answer": 2},
    {"q": "How many players are on each team in a standard LoL match?", "choices": ["3", "4", "5", "6"], "answer": 2},
    {"q": "Which champion says 'Darkness... be my shield'?", "choices": ["Nocturne", "Zed", "Kayn", "Talon"], "answer": 0},
    {"q": "What is the name of the big monster in the river that gives a buff in LoL?", "choices": ["Baron Nashor", "Dragon", "Herald", "Gromp"], "answer": 0},
    {"q": "Which region does Jinx come from?", "choices": ["Demacia", "Noxus", "Zaun/Piltover", "Freljord"], "answer": 2},
    {"q": "What does 'ADC' stand for in League of Legends?", "choices": ["Attack Damage Carry", "Area Damage Champion", "All Damage Counter", "Ability Damage Core"], "answer": 0},
    {"q": "Which champion is known as 'The Blind Monk'?", "choices": ["Master Yi", "Udyr", "Lee Sin", "Wukong"], "answer": 2},
    {"q": "What is the name of Lux's ultimate ability?", "choices": ["Light Binding", "Lucent Singularity", "Final Spark", "Prismatic Barrier"], "answer": 2},
    {"q": "Which champion has a skill called 'Tibbers'?", "choices": ["Lulu", "Nunu", "Annie", "Heimerdinger"], "answer": 2},
    {"q": "What is the first drake that spawns called?", "choices": ["It's always random", "Elder Drake", "Ocean Drake", "Cloud Drake"], "answer": 0},
    {"q": "Which champion can transform between Aspect of the Cougar and human form?", "choices": ["Elise", "Nidalee", "Gnar", "Kayn"], "answer": 1},
    {"q": "What role does Thresh typically play?", "choices": ["Jungler", "Mid laner", "Support", "Top laner"], "answer": 2},
    {"q": "Which LoL champion wields a scythe and harvests souls?", "choices": ["Mordekaiser", "Yorick", "Karthus", "Thresh"], "answer": 3},
    {"q": "What city-state does Darius come from?", "choices": ["Demacia", "Noxus", "Ionia", "Bilgewater"], "answer": 1},
    {"q": "Which champion is known as 'The Swift Scout'?", "choices": ["Caitlyn", "Ashe", "Teemo", "Twitch"], "answer": 2},
    {"q": "What is the name of Yasuo's passive ability?", "choices": ["Way of the Wanderer", "Last Breath", "Steel Tempest", "Wind Wall"], "answer": 0},
    {"q": "Which champion throws a boomerang blade as one of their abilities?", "choices": ["Draven", "Xayah", "Sivir", "Miss Fortune"], "answer": 2},
    {"q": "How many turrets are in each lane per team in LoL?", "choices": ["1", "2", "3", "4"], "answer": 2},
    {"q": "Which champion is the sister of Kayle?", "choices": ["Lux", "Morgana", "Syndra", "Diana"], "answer": 1},
    {"q": "What does the 'Baron Nashor' buff do?", "choices": ["Gives vision", "Empowers minions", "Heals allies", "Reveals enemies"], "answer": 1},
    {"q": "Which champion uses 'Feathers' as a resource mechanic?", "choices": ["Xayah", "Quinn", "Anivia", "Azir"], "answer": 0},
    {"q": "What is the name of Jinx's minigun?", "choices": ["Zapper", "Fishbones", "Pow-Pow", "Flame Chompers"], "answer": 2},
    {"q": "Which item in LoL is known for its 'active' that makes you untargetable?", "choices": ["Zhonya's Hourglass", "Stopwatch", "Guardian Angel", "Banshee's Veil"], "answer": 0},
    # Valorant
    {"q": "What is the name of the in-game currency used to buy weapons in Valorant?", "choices": ["Credits", "Creds", "VBucks", "Coins"], "answer": 1},
    {"q": "How many players are on each team in a Valorant match?", "choices": ["4", "5", "6", "3"], "answer": 1},
    {"q": "Which agent in Valorant is known for her healing abilities?", "choices": ["Viper", "Sage", "Skye", "Reyna"], "answer": 1},
    {"q": "What is the bomb called in Valorant?", "choices": ["C4", "The Bomb", "Spike", "Detonator"], "answer": 2},
    {"q": "Which Valorant agent can resurrect a fallen teammate?", "choices": ["Phoenix", "Sage", "Skye", "Killjoy"], "answer": 1},
    {"q": "What country is Jett from in Valorant?", "choices": ["Japan", "South Korea", "China", "Brazil"], "answer": 1},
    {"q": "Which agent uses a snake as part of their abilities in Valorant?", "choices": ["Viper", "Cypher", "Omen", "Yoru"], "answer": 0},
    {"q": "What is the name of Reyna's ultimate in Valorant?", "choices": ["Dismiss", "Empress", "Devour", "Leer"], "answer": 1},
    {"q": "Which Valorant agent can deploy a Nanoswarm grenade?", "choices": ["Raze", "Killjoy", "Cypher", "Brimstone"], "answer": 1},
    ...
    {"q": "Which Valorant agent can create walls of fire?", "choices": ["Viper", "Phoenix", "Brimstone", "Fade"], "answer": 1},
    {"q": "What is the name of the Valorant map set in Morocco?", "choices": ["Bind", "Haven", "Split", "Fracture"], "answer": 0},
